...
#1-Criar uma tabela de squad
#2-Criar um dao squad
#3-Criar um model squad
#4-Criar um controller squad
#5-Criar view tipo console para realizar as operacoes de CRUD de squads
